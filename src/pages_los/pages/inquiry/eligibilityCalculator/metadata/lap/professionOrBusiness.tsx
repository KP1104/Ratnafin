...
export const EligibilityCalculatorLAPBusinessOrProfessional: MetaDataType = {
  form: {
    name: "eligibilityCalculatorLAPBusinessProfessional",
  ...
  fields: [
    ...
    },
    {
      ...
      label: "Loan Aomunt Based on FOIR",
      TypographyProps: {
        style: {
          font: "initial",
        },
    ...
    },
    {
      ...
      defaultValue: "00",
      //@ts-ignore
      postValidationSetCrossFieldValues: "setNewLTVValue",
      disableCaching: true,
      GridProps: {
        xs: 12,
        md: 3,
    ...
    },
    {
      ...
      name: "foir",
      label: "FOIR up to 85%",
      placeholder: "FOIR up to 85%",
      validate: "validateFOIRUpto85Percent",
      GridProps: {
        xs: 12,
        md: 3,
        sm: 3,
    ...
    },
    {
      ...
      setValueOnDependentFieldsChange: "retailCalculateSENPLAPCondition",
      GridProps: {
        xs: 12,
        md: 3,
        sm: 3,
    ...
    },
    {
      ...
      name: "loanAmountConditionBasedLTVTypography",
    ...
    },
    {
      ...
      dependentFields: ["newltvCondition"],
      setValueOnDependentFieldsChange:
